...
fun main() {
    ...
    CatalogoProductos.agregarProducto("Monitor TUF\"",      219.99,  5, 2)
    CatalogoProductos.agregarProducto("Auriculares LOGITECH",    174.99,  8, 3)
    ...
    for(producto in CatalogoProductos.listar()){
        println("${producto.nombre} ${producto.stock}")
    }
}